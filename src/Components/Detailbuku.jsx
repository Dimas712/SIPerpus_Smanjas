  ...
  return (
    <div className='max-w-md mx-auto bg-white rounded-xl overflow-hidden md:max-w-2xl my-4'>
      <div className='md:flex'>
        ...
        <div className='p-4'>
          <div className='uppercase tracking-wide text-xl font-semibold italic'>{title}</div>
          <p className='block mt-1 text-lg leading-tight font-semibold text-black'>{author}</p>
          ...
          <button
            ...
            onClick={() => navigate('/formpinjambuku')}
          >
            Pinjam
          </button>
        </div>
